...
namespace Mail_Test.DAL
{
	...
	public partial class member
	{
		...
		public int Add(Mail_Test.Model.member model)
		{
			...
			strSql.Append("username,useremail,usergroup)");
		...
		public Mail_Test.Model.member GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,username,useremail,usergroup from member ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Mail_Test.Model.member DataRowToModel(DataRow row)
		{
			Mail_Test.Model.member model=new Mail_Test.Model.member();
			if (row != null)
			{
				...
				if(row["usergroup"]!=null && row["usergroup"].ToString()!="")
				{
					model.usergroup=int.Parse(row["usergroup"].ToString());
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,username,useremail,usergroup ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,username,useremail,usergroup ");
			strSql.Append(" FROM member ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
